    ...
    [assetWriterVideoInput requestMediaDataWhenReadyOnQueue:videoQueue usingBlock:^{
        ...
        while ([assetWriterVideoInput isReadyForMoreMediaData]) {
            ...
            if (sample) {
                ...
                NSLog(@"image size = %.2zu, %.2zu", CGImageGetWidth(cgImage), CGImageGetHeight(cgImage));
                ...
                CGContextDrawImage(newContext, CGRectMake(0.0f, 0.0f, CGImageGetWidth(cgImage), CGImageGetHeight(cgImage)), cgImage);
